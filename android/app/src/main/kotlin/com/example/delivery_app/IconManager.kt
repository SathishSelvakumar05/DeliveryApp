    ...
    fun updateAppIcon() {
        try {
            ...
            if (isNewYearPeriod) {
                ...
                // 🔍 Debug logs to confirm switch
                Log.d("IconManager", "NewYearIcon state: " + pm.getComponentEnabledSetting(newYearIcon))
                Log.d("IconManager", "DefaultIcon state: " + pm.getComponentEnabledSetting(defaultIcon))
