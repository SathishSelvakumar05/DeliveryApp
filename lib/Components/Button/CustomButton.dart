...
class _CustomElevatedButtonState extends State<CustomElevatedButton> {
  ...
  BoxDecoration _buildDecoration() {
    return BoxDecoration(
      gradient: widget.gradient ?? KConstantColors.buttonLoadingBG,
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          ...
          backgroundColor: widget.buttonType == ButtonType.elevated
              ? Color(0xFF0C1D37) // Transparent for gradient effect
          ...
          shape: RoundedRectangleBorder(
            ...
            side: widget.buttonType == ButtonType.outlined
                ? BorderSide(
                    color: widget.outlineColor ?? Color(0xFF0C1D37),
                    width: 2.0)
                : BorderSide.none,
          ),
        ...
        child:widget.isLoading?SizedBox(
            height: 25.h,
            width: 25.w,
            child: Center(child: CircularProgressIndicator(color: Colors.white,))): Text(
          widget.text,
         style: TextStyleClass.textSize(
        size:15,
      color: widget.buttonType == ButtonType.elevated
          ? widget.textColor
          : Theme.of(context).hintColor,fontWeight: FontWeight.bold  ),

          // TextStyleClass.textSize15Bold(
          //   color: widget.buttonType == ButtonType.elevated
          //       ? widget.textColor
