...
class TextStyleClass {
  static TextStyle textStyle(
      {double? size = 16, Color? color, FontWeight? fontWeight,double}) {
    //GoogleFonts.poppins
    return TextStyle(
      fontSize: size!.sp,
      fontFamily: "Manrope",
...
//all font size
  static TextStyle textSize({Color? color, FontWeight? fontWeight,double? size}) {
    return textStyle(size:size?.sp ??10.sp, color: color, fontWeight: fontWeight,);
  }
