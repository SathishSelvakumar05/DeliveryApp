...
// //       } catch (_) {
// //         _interpreter ??= await Interpreter.fromAsset('dental_model.tflite');
// //       }
// //
...
// // void main() {
// //   runApp(MaterialApp(
// //     home: DentalDetectPage(),
// //     debugShowCheckedModeBanner: false,
// //   ));
// // }
//
// class DentalDetectPage extends StatefulWidget {
//   @override
//   _DentalDetectPageState createState() => _DentalDetectPageState();
// }
//
// class _DentalDetectPageState extends State<DentalDetectPage> {
...
//         loading=false;
//         _result =
//         "${_labels[idx]} — ${(output[0][idx] * 100).toStringAsFixed(1)}%";
//       });
//
//       // Re
//       print("🔍 Output: $output");
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(title: Text("🦷 Dental Issue Detector")),
//       body: Padding(
...
//             ),
//             SizedBox(height: 20),
//             loading?CircularProgressIndicator():Text("data"),
